...
namespace Irsa.XMLModels.Retrieve_System_Fare_Quote_Request
{
    ...
    public class Retrieve_System_Fare_Quote_Request
    {
        ...
        public Retrieve_System_Fare_Quote_Request()
        {
    ...
    public class Body
    {
        [XmlElement(ElementName = "RetrieveSystemFareQuote", Namespace = NameSpaceList.tem)]
        public RetrieveSystemFareQuote RetrieveSystemFareQuote { get; set; }
    }


    [XmlRoot(ElementName = "RetrieveSystemFareQuote", Namespace = NameSpaceList.tem)]
    public class RetrieveSystemFareQuote
    {
        [XmlElement(ElementName = "RetrieveSystemFareQuoteRequest", Namespace = NameSpaceList.tem)]
        public RetrieveSystemFareQuoteRequest RetrieveSystemFareQuoteRequest { get; set; }
    }


    [XmlRoot(ElementName = "RetrieveSystemFareQuoteRequest", Namespace = NameSpaceList.tem)]
    public class RetrieveSystemFareQuoteRequest
    {
        ...
        [XmlElement(ElementName = "ReservationChannel", Namespace = NameSpaceList.radl)]
    ...
    public class FareQuoteDetail
    {
        ...
        [XmlElement(ElementName = "OverrideEffectiveDate", Namespace = NameSpaceList.radl)]
