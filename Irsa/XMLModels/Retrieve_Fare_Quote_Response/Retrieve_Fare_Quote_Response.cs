...
namespace Irsa.XMLModels.Retrieve_Fare_Quote_Response
{
    ...
    //Retrieve_Fare_Quote_Response
    [XmlRoot(ElementName = "Envelope", Namespace = NameSpaceList.s)]
    public class Retrieve_Fare_Quote_Response
    {
        ...
        public Retrieve_Fare_Quote_Response()
        {
    ...
    public class Body
    {
        [XmlElement(ElementName = "RetrieveFareQuoteResponse", Namespace = NameSpaceList.xmlns)]
        public RetrieveFareQuoteResponse RetrieveFareQuoteResponse { get; set; }
    }

    //RetrieveFareQuoteResponse
    [XmlRoot(ElementName = "RetrieveFareQuoteResponse", Namespace = NameSpaceList.xmlns)]
    public class RetrieveFareQuoteResponse
    {
        [XmlNamespaceDeclarations]
        public XmlSerializerNamespaces Namespaces = new XmlSerializerNamespaces();

        [XmlElement(ElementName = "RetrieveFareQuoteResult", Namespace = NameSpaceList.xmlns)]
        public RetrieveFareQuoteResult RetrieveFareQuoteResult { get; set; }

        public RetrieveFareQuoteResponse()
        {
    ...
    [XmlRoot(ElementName = "RetrieveFareQuoteResult", Namespace = NameSpaceList.xmlns)]
    public class RetrieveFareQuoteResult
    {
        ...
        public RetrieveFareQuoteResult()
        {
